...
make PLATFORM_VERSION=12 ANDROID_MAJOR_VERSION=s LLVM=1 LLVM_IAS=1 ARCH=arm64 TARGET_SOC=s5e8825 CROSS_COMPILE=~/build-tools/linux-x86/clang-r416183b/bin/aarch64-linux-gnu- s5e8825-a53xcis_defconfig
